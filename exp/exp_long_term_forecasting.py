...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def _select_optimizer(self):
        model_optim = optim.Adam(self.model.parameters(), lr=self.args.learning_rate, betas=(0.9, 0.999))
        return model_optim
    ...
    def train(self, setting):
        ...
        scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(model_optim, 'min', factor=.5, patience=1)
        ...
        for epoch in range(self.args.train_epochs):
            ...
            print("Epoch: {0}, Steps: {1} | Train Loss: {2:.7f} Vali Loss: {3:.7f} Test Loss: {4:.7f}".format(
                epoch + 1, train_steps, train_loss, vali_loss, test_loss), end=' ')
